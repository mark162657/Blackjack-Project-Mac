        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-slate-900/60 p-8 rounded-2xl shadow-2xl w-full max-w-md border border-white/20 animate-fade-in-down">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <Button bg_color="blue" type="submit" disabled={loading} className="w-full !py-3 !text-base">{loading ? 'Processing...' : title}</Button>
                </form>
                ...
                <div className="mt-6 text-center">
                    <button onClick={() => { setIsLogin(!isLogin); setMessage(''); }} className="text-sm text-blue-400 hover:text-blue-300 transition" disabled={loading}>
